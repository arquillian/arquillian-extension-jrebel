...
// -------------------------- OTHER METHODS --------------------------
    ...
    public void getFileAssets()
    {
        ...
        Assert.assertEquals(6, fileOrClassAssets.size());
        for (Asset asset : fileOrClassAssets) {
            if (asset instanceof FileAsset) {
                ...
                Assert.assertTrue(serializerClassAsset.equals(asset) || fake1ClassAsset.equals(asset) || fake2ClassAsset.equals(asset));
            } else {
        ...
        Assert.assertEquals(12, nonFileAssests.size());
